        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Redemption Successful!', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Text(reward['name'] ?? 'Reward', style: TextStyle(color: AppTheme.textSecondary)),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    const Text('Your Reward Code', style: TextStyle(color: AppTheme.textSecondary)),
