...
class BrandLoyaltyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final about = brand?['about'] ??
        'Premium fashion destination offering the latest trends in clothing, accessories, and lifestyle products.';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Brand Loyalty',
            style: TextStyle(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Brand Stamp Progress',
                      style:
                          TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 16),
                  Row(
                  ...
                  Text('$progress/$total STAMPS COLLECTED',
                      style: const TextStyle(
                          fontSize: 12,
